...
### Known issues ###
# Trim of the $badSuffix removes the 'n' from '.json' files at minimum when $badSuffix = "*.3ncrypt3d"
## Seems to be an issue with .TrimEnd
### PS > ("8.json.3ncrypt3d").TrimEnd(".3ncrypt3d") 
### 8.jso
## Could be scripted out in this particular case with an if statement but that is one more step... however this is dumping bad data right now so...?
